function [frame_time,time_cyc] = ensemble_avg_frames_dye
%==========================================================================
% ensemble_avg_frames_dye.m
%
%ENSEMBLE_AVG_FRAMES Use shoreline motion and bore collapse location to define
...
%==========================================================================
    ...
    load("../../7_dye/shoreline_dye.mat",'bins','wave') %shoreline location
